...
# ============================================================================
# TESSERACT CONFIGURATION - MUST BE AT THE TOP
# ============================================================================
...
try:
    ...
    TESSERACT_AVAILABLE = False
    print("⚠️ Warning: pytesseract module not installed")
except Exception as e:
    TESSERACT_AVAILABLE = False
    print(f"⚠️ Warning: Tesseract configuration error - {e}")
...
class SimplifiedTrafficViolationDetector:
    ...
    def __init__(self, api_key: str = "uIDYA2LCUA7P0FcwWMHm"):
